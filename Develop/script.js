...
// Confirm the rest of character conditions
       ...
       if(confirm("If you would like to include lower case letters in your password, select OK. \nOtherwise, select Cancel.")){
           Array.prototype.push.apply(characters, charLowercase);
       }
 
       if(confirm("If you would like to include upper case letters in your password, select OK. \nOtherwise, select Cancel.")){
           Array.prototype.push.apply(characters, charUppercase);
       }
 
       if(confirm("If you would like to include numbers in your password, select OK. \nOtherwise, select Cancel.")){
           Array.prototype.push.apply(characters, charNumeric);
       }
 
       if(confirm("If you would like to include special characters/symbols in your password, select OK. \nOtherwise, select Cancel.")){
